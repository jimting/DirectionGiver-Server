...
@WebServlet("/NearServlet")
public class NearServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ShowNearBy test1 = new ShowNearBy();
		
		JSONArray near = new JSONArray();
		try {
			Class.forName("com.mysql.jdbc.Driver");
			near = test1.show(leftBottomLng,leftBottomLat,rightTopLng,rightTopLat,longitude,latitude);	
